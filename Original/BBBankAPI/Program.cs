...
// ASP.NET Core infrastructre logs that are Information and below will be filtered out.
.MinimumLevel.Override("Microsoft.AspNetCore", LogEventLevel.Warning)
// Picking up configuration from appsettings.
.ReadFrom.Configuration(builder.Configuration)
.Enrich.FromLogContext()
// Creating Serilog logger object based on the configuratoin above. 
.CreateLogger();
